                ...
                <div className="w-full space-y-6">
                    ...
                    <section className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm">
                        ...
                        <div className="mt-5 space-y-3">
                            {[
                                { name: "펠리체카페", address: "대전 중구 대종로 363", hours: "매일 10:00 - 21:00" },
                                { name: "브릭식스", address: "대전 중구 대종로 430-2", hours: "월-금 11:30 - 22:00" },
                                { name: "카이모카", address: "대전 중구 보문로 9-12", hours: "매일 09:00 - 22:00" },
                            ].map((s, i) => (
                                <div
                                    key={i}
