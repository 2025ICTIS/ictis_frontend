            ...
            <div className="relative z-[301] h-full w-full bg-white">
                ...
                <main className="flex-1 min-h-0 overflow-y-auto">
                    ...
                    <div className="px-4 py-4">
                        {!latestReview ? (
                            <div
                                className="p-6 text-sm text-center text-gray-600 border border-gray-300 border-dashed rounded-2xl">
                            ...
                            <>
                                <div className="flex items-center justify-between">
                                    <div className="flex justify-between items-center gap-3">
                                        <div className="flex w-8 h-8 bg-gray-200 rounded-full"/>
                    ...
                    {!isReviewed ? (
                        !isPlanned ? (
                            <button
                                ...
                                className="w-full py-4 text-white bg-pink-500 shadow-lg rounded-2xl hover:bg-pink-600 cursor-pointer"
                            >
                                방문 일정에 추가하기
                            </button>
                        ) : (
